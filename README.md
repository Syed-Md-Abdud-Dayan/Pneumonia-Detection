...
### 1. Open the Notebook `Pneumonia_Detection.ipynb` using **Google Colab**.

### 2. Upload the project folder to your Google Drive. The dataset should be located inside the `Archive` folder with the following structure:
